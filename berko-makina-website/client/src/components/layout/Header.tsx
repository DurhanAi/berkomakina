...
export default function Header() {
  ...
  return (
    <header className="sticky top-0 z-50">
      <div className="bg-sky-500/80 text-white py-1">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex justify-between items-center text-sm">
          ...
          <div className="flex items-center space-x-4">
            <a href="mailto:info@berkomakina.com" className="flex items-center hover:text-sky-100">
            ...
            <div className="flex items-center flex-1">
              <div className="flex items-center justify-between w-full md:w-auto">
                <Link href="/" className="flex items-center group">
                  ...
                  <span className="text-2xl font-semibold text-gray-900 md:hidden">Berko Makina</span>
                </Link>
