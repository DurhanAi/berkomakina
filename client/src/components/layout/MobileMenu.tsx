...
export default function MobileMenu({ isOpen, setIsOpen }: MobileMenuProps) {
  ...
  return (
    <>
      ...
      {/* Mobile Menu */}
      <div className={`fixed inset-x-0 top-0 z-50 bg-white shadow-lg md:hidden transform transition-transform duration-300 ease-in-out ${isOpen ? 'translate-y-0' : '-translate-y-full'}`} id="mobile-menu">
        <div className="pt-20 pb-3 px-4 space-y-1 max-h-screen overflow-y-auto">
          <Link 
            href="/" 
