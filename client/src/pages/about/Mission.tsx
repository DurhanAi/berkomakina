          ...
          <div className="space-y-10 md:space-y-0 md:grid md:grid-cols-1 md:gap-x-8 md:gap-y-10">
            <div className="relative bg-white p-6 shadow-lg rounded-lg">
              <div className="text-center">
                <h3 className="text-2xl font-medium text-gray-900 mt-4">{t.missionDetailTitle1}</h3>
                <p className="mt-4 text-lg text-gray-600 leading-relaxed">
                  {t.missionDetailDesc1}
                </p>
              </div>
            </div>
            ...
            <div className="relative bg-gray-50 p-6 shadow-sm rounded-lg mt-8">
              <div className="space-y-6">
                <div className="flex items-start">
                  ...
                  <div className="ml-4">
                    <h4 className="text-lg font-medium text-gray-900">{t.missionDetailTitle2}</h4>
                    <p className="mt-2 text-base text-gray-600">
                      {t.missionDetailDesc2}
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-start">
                  ...
                  <div className="ml-4">
                    <h4 className="text-lg font-medium text-gray-900">{t.missionDetailTitle3}</h4>
                    <p className="mt-2 text-base text-gray-600">
                      {t.missionDetailDesc3}
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-start">
                  ...
                  <div className="ml-4">
                    <h4 className="text-lg font-medium text-gray-900">{t.missionDetailTitle4}</h4>
                    <p className="mt-2 text-base text-gray-600">
                      {t.missionDetailDesc4}
                    </p>
                  </div>
                </div>
              </div>
